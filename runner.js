    ...
    function b(n, q, p, t) {
        if ("object" === typeof process && "object" === typeof process.versions && "string" === typeof process.versions.node)
            ...
            v.onprogress = function(r) {
                ...
                r.total && (C = r.total);
                if (r.loaded) {
                    v.Ki ? h.Gj[n].loaded = r.loaded : (v.Ki = !0,
                    h.Gj || (h.Gj = {}),
                    h.Gj[n] = {
                        loaded: r.loaded,
                        total: C
                    ...
                    !h.Gj && h.setStatus && h.setStatus("Downloading data...")
            }
            ;
            v.onerror = function() {
    ...
    function d() {
        ...
        function q(v) {
            ...
            for (var r = 0; r < v.length; ++r)
                n.prototype.Ki[v[r].filename].onload();
        ...
        n.prototype = {
            ...
            send: function() {},
            onload: function() {
                this.Qi(this.Vi.subarray(this.start, this.end))
            },
            Qi: function(v) {
...
GXMFS = {
    ...
    qk: (a, b) => {
        ...
        return 16384 === (d.mode & 61440) ? b(null, {
            timestamp: d.mtime,
            mode: d.mode
        }) : 32768 === (d.mode & 61440) ? (c.Mi = B.Qk(c),
        b(null, {
            timestamp: d.mtime,
            mode: d.mode,
            contents: c.Mi
...
var H, fb, Sb = {
    ...
    1448799: function() {
        ...
        a.Ki.removeAttribute("src"),
        a.Ki.load())
    },
    1449049: function(a, b, c) {
        var d = document.querySelector("canvas");
        if (null != d.Qj)
            return b = d.Qj.getImageData(0, 0, b, c),
    ...
    1450017: function(a) {
        ...
        const g = () => {
            ...
            null == l.Vi ? (l.Vi = document.createElement("canvas"),
            l.Vi.style.cssText = "position:fixed; top:1px; left:1px; width:1px; height:1px",
            l.Vi.width = d.videoWidth,
            l.Vi.height = d.videoHeight,
            document.body.appendChild(l.Vi),
            l.Qj = l.Vi.getContext("2d", {
                alpha: !1,
                $l: !1,
                powerPreference: "low-power",
                desynchronized: !0,
                preserveDrawingBuffer: !0
            })) : (d.videoWidth != l.Vi.width && (l.Vi.width = d.videoWidth),
            l.Vi.height != d.videoHeight && (l.Vi.height = d.videoHeight));
    ...
    1454840: function(a, b, c, d) {
        ...
        null == e.ej && (e.ej = document.createElement("canvas"),
        e.ej.style.cssText = "position:fixed; top:1px; left:1px; width:1px; height:1px",
        e.ej.width = a,
        e.ej.height = b,
        document.body.appendChild(e.ej),
        console.log("Game Canvas width:" + e.width + " height:" + e.height),
        e.fl = e.ej.getContext("2d", {
            alpha: !1,
            desynchronized: !0,
            antialias: !0,
            powerPreference: "low-power",
        ...
        e.uj = document.createElement("video"),
        e.uj.autoplay = !0,
        e.uj.Wl = !0,
        e.uj.muted = !0,
        e.uj.style.cssText = "position:fixed;top:1px;left:1px;width:1px;height:1px",
        document.body.appendChild(e.uj),
        e.uj.srcObject = e.Ek,
        a = e.ej.captureStream(c),
    ...
    1469912: function(a) {
        ...
        var b = h.SDL2;
        a ? b.capture = {} : b.audio = {};
        b.Ri || ("undefined" !== typeof AudioContext ? b.Ri = new AudioContext : "undefined" !== typeof webkitAudioContext && (b.Ri = new webkitAudioContext),
        b.Ri && Qb(b.Ri));
    ...
    1470473: function(a, b, c, d) {
        function e() {}
        function f(l) {
            void 0 !== g.capture.Nj && (clearTimeout(g.capture.Nj),
            g.capture.Nj = void 0);
    ...
    1472125: function(a, b, c, d) {
        ...
        e.audio.Xi.onaudioprocess = function(f) {
            void 0 !== e && void 0 !== e.audio && (e.audio.Mk = f.outputBuffer,
            Rb("vi", c, [d]))
        }
        ;
    ...
    1472535: function(a, b) {
        for (var c = h.SDL2, d = c.capture.jk.numberOfChannels, e = 0; e < d; ++e) {
    ...
    1473620: function(a) {
        ...
        if (a) {
            ...
            void 0 !== b.capture.Xi && (b.capture.Xi.onaudioprocess = function() {}
            ,
            b.capture.Xi.disconnect(),
            b.capture.Xi = void 0);
            void 0 !== b.capture.Uj && (b.capture.Uj.disconnect(),
            b.capture.Uj = void 0);
            void 0 !== b.capture.$j && (b.capture.$j = void 0);
            b.capture = void 0
        } else
            void 0 != b.audio.Xi && (b.audio.Xi.disconnect(),
            b.audio.Xi = void 0),
            b.audio = void 0;
        void 0 !== b.Ri && void 0 === b.audio && void 0 === b.capture && (b.Ri.close(),
        b.Ri = void 0)
    },
    1474792: function(a, b, c) {
        h.SDL2 || (h.SDL2 = {});
        var d = h.SDL2;
        d.ll !== h.canvas && (d.fj = h.createContext(h.canvas, !1, !0),
        d.ll = h.canvas);
        if (d.w !== a || d.yl !== b || d.Bl !== d.fj)
            d.image = d.fj.createImageData(a, b),
            d.w = a,
            d.yl = b,
            d.Bl = d.fj;
        a = d.image.data;
        ...
        else if (d.nl !== a && (d.ml = new Int32Array(a.buffer),
        d.ol = new Uint8Array(a.buffer),
        d.nl = a),
        a = d.ml,
        c = a.length,
...
var hc = {
    ...
    write: function(a, b, c, d) {
        if (!a.tty || !a.tty.Ij.tk)
            throw new Q(60);
        try {
            for (var e = 0; e < d; e++)
                a.tty.Ij.tk(a.tty, b[c + e])
        } catch (f) {
            throw new Q(29);
        }
  ...
  , B = {
    ...
    createNode: function(a, b, c, d) {
        ...
        c = mc(a, b, c, d);
        16384 === (c.mode & 61440) ? (c.Li = B.hj.dir.node,
        c.Ni = B.hj.dir.stream,
        c.Mi = {}) : 32768 === (c.mode & 61440) ? (c.Li = B.hj.file.node,
        c.Ni = B.hj.file.stream,
        c.Oi = 0,
        c.Mi = null) : 40960 === (c.mode & 61440) ? (c.Li = B.hj.link.node,
        c.Ni = B.hj.link.stream) : 8192 === (c.mode & 61440) && (c.Li = B.hj.Lk.node,
        c.Ni = B.hj.Lk.stream);
    ...
    Ok: function(a, b) {
        ...
        0 < a.Oi && a.Mi.set(c.subarray(0, a.Oi), 0))
    },
    Kl: function(a, b) {
        if (a.Oi != b)
            if (0 == b)
    ...
    Li: {
        gj: function(a) {
            ...
            b.gid = 0;
            b.rdev = a.rdev;
            16384 === (a.mode & 61440) ? b.size = 4096 : 32768 === (a.mode & 61440) ? b.size = a.Oi : 40960 === (a.mode & 61440) ? b.size = a.link.length : b.size = 0;
        ...
        readdir: function(a) {
            var b = [".", ".."], c;
            for (c in a.Mi)
                a.Mi.hasOwnProperty(c) && b.push(c);
            return b
        },
    ...
    Ni: {
        ...
        write: function(a, b, c, d, e, f) {
            ...
            if (b.subarray && (!a.Mi || a.Mi.subarray)) {
                if (f)
                    return a.Mi = b.subarray(c, c + d),
                    a.Oi = d;
                if (0 === a.Oi && 0 === e)
                    return a.Mi = b.slice(c, c + d),
                    a.Oi = d;
                if (e + d <= a.Oi)
                    return a.Mi.set(b.subarray(c, c + d), e),
                    d
            }
            B.Ok(a, e + d);
            if (a.Mi.subarray && b.subarray)
                a.Mi.set(b.subarray(c, c + d), e);
            else
                for (f = 0; f < d; f++)
                    a.Mi[e + f] = b[c + f];
...
, oc = (a, b) => {
    var c;
    if (c = (c = Cc(a, "x")) ? c : a.Li.lookup ? 0 : 2)
        throw new Q(c,a);
...
, Da = (a, b) => {
    ...
    if ("string" == typeof b) {
        ...
        Uc(a, b, 0, b.byteLength, void 0, c.Jk);
    else
    ...
    f.prototype.Ik = function() {
        ...
        y.Ki(F => {
            ...
            if ("undefined" == typeof y.oj[F]) {
                var z = y.oj;
                if (J > M)
                    throw Error("invalid range (" + J + ", " + M + ") or no bytes requested!");
                if (M > t - 1)
        ...
        if (!jb)
            if (0 < Ad.length) {
                ...
                1 == pd && 1 < qd && 0 != Dd % qd)
                    ...
                    b < zd || ("object" == typeof SDL && SDL.audio && SDL.audio.Hl && SDL.audio.Hl(),
                    td())
                }
    }
}
...
function Kd() {
    ...
    if (!Ld) {
        ...
        h.$k || "undefined" != typeof Od || (Xa("warning: Browser does not support creating object URLs. Built-in browser image decoding will not be available."),
        h.$k = !0);
...
function Ze(a) {
    ...
    if (a.$i)
        a.sl = b,
        a.target.addEventListener(a.Ui, b, a.Zi),
        Se.push(a),
        $e || (Ab.push(Re),
        $e = !0);
    else
        for (var c = 0; c < Se.length; ++c)
            Se[c].target == a.target && Se[c].Ui == a.Ui && Te(c--)
}
function af(a) {
...
function xf(a) {
    function b() {
        ...
        document.body.style.margin = J,
        document.documentElement.style.overflow = M,
        document.body.scroll = z,
        a.style.Tk = L,
        a.Mj && a.Mj.dj.viewport(0, 0, d, e),
        qf.Sj && P(qf.Sj)(37, 0, qf.Kk))
    }
    var c = uf(a)
      , d = c[0]
      , e = c[1]
...
function Af(a, b) {
    if (0 != b.yk || 0 != b.ik) {
        ...
        var g = uf(a)
          , l = g[0];
        g = g[1];
        3 == b.yk ? (yf(a, (d - e) / 2, (c - f) / 2),
        c = f,
        d = e) : 2 == b.yk && (c * g < l * d ? (f = g * c / l,
        yf(a, (d - f) / 2, 0),
        d = f) : (f = l * d / g,
        yf(a, 0, (c - f) / 2),
        c = f));
...
function Bf(a) {
    if (a.requestPointerLock)
        ...
        return document.body.requestPointerLock || document.body.Wj ? -3 : -1;
    return 0
}
function Cf(a, b) {
    gb[a >> 3] = b.timestamp;
...
function Pf(a, b, c, d) {
    if (c)
        if (S.bj[a].enabled && k("glGetVertexAttrib*v on client-side array: not supported, bad data returned"),
...
function Vf(a, b) {
    if (!bf())
        return -1;
    a = sf(a);
    return a ? a.requestFullscreen || a.webkitRequestFullscreen ? Qe && Ye.vj ? Af(a, b) : b.pl ? (Ve(Af, 1, [a, b]),
    1) : -2 : -3 : -4
}
function Wf(a, b) {
    var c = {
    ...
    Ze({
        ...
        aj: function(g) {
            ...
            for (p = 0; p < g.targetTouches.length; ++p)
                n[g.targetTouches[p].identifier].al = 1;
            q = nf;
            gb[q >> 3] = g.timeStamp;
            var t = q >> 2;
            G[t + 3] = g.ctrlKey;
...
var Xg = {
    ...
    sh: function(a, b) {
        ...
        S === Td[a] && (S = null);
        if ("object" == typeof cf)
            for (var c = Td[a].dj.canvas, d = 0; d < Se.length; ++d)
                Se[d].target != c || Te(d--);
        Td[a] && Td[a].dj.canvas && (Td[a].dj.canvas.Mj = void 0);
        Td[a] = null;
        U = 12288;
        ee == b && (ee = 0);
        return 1
    ...
    rg: function(a, b, c, d, e, f, g, l, n) {
        2 <= S.version ? T.Ti ? T.compressedTexSubImage2D(a, b, c, d, e, f, g, l, n) : T.compressedTexSubImage2D(a, b, c, d, e, f, g, A, n, l) : T.compressedTexSubImage2D(a, b, c, d, e, f, g, n ? A.subarray(n, n + l) : null)
    },
    ...
    xd: function(a, b, c) {
        if (Ff(a)) {
            var d = pe[Ef(a)];
            d ? d.Fk & 16 ? 0 > b || 0 > c || b + c > d.length ? (X(1281),
            k("invalid range in glFlushMappedBufferRange")) : T.bufferSubData(a, d.offset, A.subarray(d.Cj + b, d.Cj + b + c)) : (X(1282),
            ...
            35716 == b)
                ...
                if (!a.nj)
                    for (b = 0; b < T.getProgramParameter(a, 35718); ++b)
                        a.nj = Math.max(a.nj, T.getActiveUniform(a, b).name.length + 1);
                G[c >> 2] = a.nj
            } else if (35722 == b) {
                if (!a.lj)
                    for (b = 0; b < T.getProgramParameter(a, 35721); ++b)
                        a.lj = Math.max(a.lj, T.getActiveAttrib(a, b).name.length + 1);
                G[c >> 2] = a.lj
            } else if (35381 == b) {
                if (!a.mj)
                    for (b = 0; b < T.getProgramParameter(a, 35382); ++b)
                        a.mj = Math.max(a.mj, T.getActiveUniformBlockName(a, b).length + 1);
                G[c >> 2] = a.mj
            } else
    ...
    lf: function(a, b, c) {
        c ? (S.bj[a].enabled && k("glGetVertexAttribPointer on client-side array: not supported, bad data returned"),
    ...
    Xa: function(a, b) {
        a = sf(a);
        return a ? a.requestPointerLock || a.Wj ? Qe && Ye.vj ? Bf(a) : b ? (Ve(Bf, 2, [a]),
        1) : -2 : -1 : -4
    },
    Ab: function(a) {
        var b = A.length;
    ...
    Ta: function(a, b, c, d) {
        if (!document || !document.body || !(document.body.requestPointerLock || document.body.hk || document.body.Xl || document.body.Wj))
            return -1;
        a = sf(a);
        if (!a)
            return -4;
    ...
    Fa: function(a, b, c, d) {
        try {
            ...
            if ("undefined" == typeof fd || !(J instanceof Q))
                throw J;
            return J.Pi
        }
    },
...
var m = h._malloc = function() {
  ...
  , Ig = h.___errno_location = function() {
    return (Ig = h.___errno_location = h.asm.ii).apply(null, arguments)
}
;
...
(function() {
    if ("undefined" != typeof window && !window.Ki) {
        ...
        class c {
            ...
            destroy() {
                null != this.jj && this.jj && (this.jj.close(),
                this.jj = null);
                this.yj = null
            }
            async connect(d, e) {
